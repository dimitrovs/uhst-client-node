...
util__default['default'].inherits(EventSource, events__default['default'].EventEmitter);
        ...
        return __awaiter$1(this, void 0, void 0, function () {
            ...
            return __generator$1(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fetch(url + "?token=" + token, __assign(__assign({}, REQUEST_OPTIONS$1), { body: JSON.stringify(message) }))];
                    case 2:
                        response = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
...
var EventRunnerDefault = /** @class */ (function (_super) {
    __extends$1(EventRunnerDefault, _super);
...
var EventRunnerNTimes = /** @class */ (function (_super) {
    __extends$2(EventRunnerNTimes, _super);
...
var EventEmitter = /** @class */ (function () {
    ...
    EventEmitter.prototype.off = function (eventName, handler) {
        ...
        this._events[eventName] = events.filter(function (h) { return h.getHandler() !== handler; });
    };
    ...
    EventEmitter.prototype.emit = function (eventName) {
        ...
        var events = this._events[eventName];
        if (events) {
            events.forEach(function (handler) { return handler.run.apply(handler, __spreadArrays$1([eventName], args)); });
        }
    };
...
var UhstHost = /** @class */ (function () {
    ...
    UhstHost.prototype.handleMessage = function (message) {
        var clientId = o(message.responseToken).clientId;
...
exports.HostIdAlreadyInUse = HostIdAlreadyInUse;
exports.InvalidClientOrHostId = InvalidClientOrHostId;
exports.InvalidHostId = InvalidHostId;
exports.InvalidToken = InvalidToken;
exports.NetworkClient = NetworkClient;
exports.NetworkError = NetworkError;
exports.NetworkUnreachable = NetworkUnreachable;
exports.RelayClientProvider = RelayClientProvider;
exports.RelayError = RelayError;
exports.RelayUnreachable = RelayUnreachable;
exports.UHST = UHST;
